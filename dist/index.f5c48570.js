...
var _slickJs = require("slick-carousel/slick/slick.js");
(0, _jqueryDefault.default)(function() {
    const worksSlider = (0, _jqueryDefault.default)('[data-slider="slick"]');
    // Filter
    let filter = (0, _jqueryDefault.default)("[data-filter]");
    filter.on("click", function(event) {
        event.preventDefault();
        let cat = (0, _jqueryDefault.default)(this).data("filter");
        if (cat == "all") (0, _jqueryDefault.default)("[data-cat]").removeClass("hide");
        else (0, _jqueryDefault.default)("[data-cat]").each(function() {
            let workCat = (0, _jqueryDefault.default)(this).data("cat");
            if (workCat != cat) (0, _jqueryDefault.default)(this).addClass("hide");
            else (0, _jqueryDefault.default)(this).removeClass("hide");
        });
    });
    // Modal
    const modalCall = (0, _jqueryDefault.default)("[data-modal]");
    const modalClose = (0, _jqueryDefault.default)("[data-close]");
    modalCall.on("click", function(event) {
        event.preventDefault();
        let $this = (0, _jqueryDefault.default)(this);
        let modalId1 = $this.data("modal");
        (0, _jqueryDefault.default)(modalId1).addClass("show");
        (0, _jqueryDefault.default)("body").addClass("no-scroll");
        setTimeout(function() {
            (0, _jqueryDefault.default)(modalId1).find(".modal__dialog").css({
                transform: "rotateX(0)"
            });
        }, 200);
    ...
    modalClose.on("click", function(event) {
        ...
        (0, _jqueryDefault.default)(modalId).find(".modal__dialog").css({
            transform: "rotateX(0deg)"
        });
        setTimeout(function() {
            modalParent.removeClass("show");
            (0, _jqueryDefault.default)("body").removeClass("no-scroll");
        }, 200);
    });
    (0, _jqueryDefault.default)(".modal").on("click", function(event) {
        let $this = (0, _jqueryDefault.default)(this);
    ...
    (0, _jqueryDefault.default)(".modal__content").on("click", function(event) {
        event.stopPropagation();
    });
    (0, _jqueryDefault.default)(".modal-work").on("click", function(event) {
        event.stopPropagation();
    });
    (0, _jqueryDefault.default)(".contact").on("click", function(event) {
        event.stopPropagation();
    });
    ...
    (0, _jqueryDefault.default)(".slickPrev").on("click", function(event) {
        event.preventDefault();
        let currentSlider = (0, _jqueryDefault.default)(this).parents(".modal").find("slickPrev");
        (0, _jqueryDefault.default)("worksSlider").slick('[data-slider="slick"]');
    });
    (0, _jqueryDefault.default)(".slickNext").on("click", function(event) {
        event.preventDefault();
        let currentSlider = (0, _jqueryDefault.default)(this).parents(".modal").find("slickPrev");
        currentSlider.slick("slickNext");
    });
    // Mobile nav
    const navToggle = (0, _jqueryDefault.default)("#navToggle");
    const nav = (0, _jqueryDefault.default)("#nav");
...
},{"jquery":"hgMhh","slick-carousel/slick/slick.js":"ghMFH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{"49d534af0a028930":"hgMhh"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["fH7gS","8ZNvh"], "8ZNvh", "parcelRequire2041")
